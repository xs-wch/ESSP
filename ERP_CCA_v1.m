function [SP,SF,C,Z,nc_est,Phi] = ERP_CCA_v1(simu_EEG1,simu_EEG2,frq_up,nc_up,fs)
...
if nargin == 0
    ...
    clear all
    close all
	[simu_EEG1,simu_EEG2,SP,SF,dZ] = ERP_data_gen(-15,45);
	frq_up = 100;
	nc_up = 10;
	fs = 1000;
...
for i = 1:trial
    simu_EEG1(:,:,i) = detrend(squeeze(simu_EEG1(:,:,i))','constant')';
    simu_EEG2(:,:,i) = detrend(squeeze(simu_EEG2(:,:,i))','constant')';
end
simu_EEG = simu_EEG1-simu_EEG2;
concatEEG = simu_EEG(:,:);
