...
%    frq_low - frequency lowbound (default 0Hz)
%    frq_up - frequency upbound (default 100Hz)
%    nc_up - number of ERP components uplimit (default 10)
%    fs - sample rate (default 1000)
